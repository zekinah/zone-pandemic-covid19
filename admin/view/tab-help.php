...
<div class="container-fluid">
    ...
    <ul>
        ...
        <li>[zone-covid19 country="USA"]</li>
        <li>[zone-covid19 country="United States"]</li>
    </ul>
    <div class="row">
        <div class="col-md-12">
            <table class="table tablesorter" id="tbl-countries">
                <thead>
                    <tr>
                        <th class="head headerSortDown headerSortUp">Country Name</th>
                        <th class="head">ISO 2</th>
                        <th class="head">ISO 3</th>
                        <th class="head">Code Country</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
